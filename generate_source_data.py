...
def main():
    ...
    save_to_sql_server(transaction_data, 'TransactionData', connection_string)
    save_to_sql_server(crm_data, 'CRMData', connection_string)
    save_to_sql_server(marketing_attribution_data, 'MarketingAttributionData', connection_string)
